...
//Create Post
  const createPost = async (event) => {
    ...
    const res = await axios.post('https://mern-stack-crud.herokuapp.com/post', createForm)
...
const deletePost = async (_id) => {
  //Delete the post
  await axios.delete(`https://mern-stack-crud.herokuapp.com/posts/${_id}`)
...
const updatePost = async (event) => {
  ...
  const res = await axios.put(`https://mern-stack-crud.herokuapp.com/posts/${updateForm._id}`, {
    topic,
    description,
    postCategory
  })
